...
email_ele.send_keys("pokalabhargavi99@gmail.com")
next_but1= driver.find_element(b.ID,"identifierNext")
next_but1.click()
time.sleep(2)
#driver.implicitly_wait(5)
#WebDriverWait(driver,5).until(EC.presence_of_element_located((b.NAME,"password")))
pass_ele = driver.find_element(b.NAME,"password")
pass_ele.send_keys("Likhith@01")
